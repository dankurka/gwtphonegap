...
public class InAppBrowserReferenceJsImpl extends InAppBrowserReferenceBaseImpl {
  ...
  public native void executeScript(String code, InAppBrowserCallback callback) /*-{
    ...
    var c = function(result){
      callback.@com.googlecode.gwtphonegap.client.inappbrowser.InAppBrowserCallback::done(*)(result);
    };
  ...
  public native void injectCss(String css, InAppBrowserCallback callback) /*-{
    ...
    var script = {code: css};
    var c = function(){
      callback.@com.googlecode.gwtphonegap.client.inappbrowser.InAppBrowserCallback::done(*)(null);
    };
