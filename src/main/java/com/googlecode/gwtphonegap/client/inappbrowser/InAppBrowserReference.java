...
public interface InAppBrowserReference {
  ...
  HandlerRegistration addLoadStopHandler(LoadStopHandler handler);

  HandlerRegistration addExitHandler(ExitHandler handler);

  HandlerRegistration addLoadErrorHandler(LoadErrorHandler handler);
